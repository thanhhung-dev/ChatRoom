...
class ResetPasswordViewController: UIViewController {
  ...
  private lazy var newPasswordField: UITextField = createTextField(
    placeholder: "••••••••", title: "Mật khẩu mới", isSecure: true)
  ...
  private func setupLayout() {
    ...
    let components = [
      backButton, titleLabel, subtitleLabel, newPasswordField, confirmPasswordField, updateButton,
    ]
    ...
    NSLayoutConstraint.activate([
      ...
      confirmPasswordField.topAnchor.constraint(
        equalTo: newPasswordField.bottomAnchor, constant: 24),
