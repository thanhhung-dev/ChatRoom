...
class RegisterViewController: UIViewController {
    ...
    private let subtitleLabel: UILabel = {
        let label = UILabel()
        label.text = "Tham gia BoxChat ngay hôm nay!"
    ...
    private lazy var usernameField: UITextField = createCustomTextField(
        placeholder: "Tên đăng nhập", iconName: "person.fill", isSecure: false, keyboardType: .default
    )
    
    private lazy var emailField: UITextField = createCustomTextField(
        placeholder: "Địa chỉ Email", iconName: "envelope.fill", isSecure: false, keyboardType: .emailAddress
    )
    
    private lazy var passwordField: UITextField = createCustomTextField(
        placeholder: "Mật khẩu", iconName: "lock.fill", isSecure: true, keyboardType: .default
    )
    ...
    private func setupLayout() {
        ...
        let textFieldsStack = UIStackView(arrangedSubviews: [usernameField, emailField, passwordField])
        textFieldsStack.axis = .vertical
        textFieldsStack.spacing = 16
        
        let mainStack = UIStackView(arrangedSubviews: [
            titleLabel, subtitleLabel, textFieldsStack, registerButton
        ])
        ...
        NSLayoutConstraint.activate([
            ...
            backToLoginButton.bottomAnchor.constraint(equalTo: view.safeAreaLayoutGuide.bottomAnchor, constant: -16),
            backToLoginButton.centerXAnchor.constraint(equalTo: view.centerXAnchor)
        ])
    }
    
    private func createCustomTextField(placeholder: String, iconName: String, isSecure: Bool, keyboardType: UIKeyboardType) -> UITextField {
        let tf = UITextField()
    ...
    @objc private func keyboardWillShow(notification: NSNotification) {
        if let keyboardFrame = notification.userInfo?[UIResponder.keyboardFrameEndUserInfoKey] as? NSValue {
            ...
            // Đẩy form lên cao hơn một chút vì form Đăng ký có 3 ô textfield dài hơn
            UIView.animate(withDuration: 0.3) {
                self.cardCenterYConstraint?.constant = -(keyboardHeight / 2 + 10)
    ...
    @objc private func didTapRegister() {
        ...
        NetworkManager.shared.register(params: params) { [weak self] result in
                ...
                case .success:
                    ...
                    if let windowScene = UIApplication.shared.connectedScenes.first as? UIWindowScene,
                       ...
                       let window = sceneDelegate.window {
                        ...
                        // FIX LỖI LUỒNG: Vào thẳng TabBar đồng bộ với Login
