...
class RegisterViewController: UIViewController {
    ...
    private lazy var nameField: UITextField = createTextField(placeholder: "Nguyễn Văn A", title: "Họ và tên", isSecure: false)
    private lazy var emailField: UITextField = createTextField(placeholder: "nguyenvana@gmail.com", title: "Email", isSecure: false)
    ...
    private let termsLabel: UILabel = {
        let l = UILabel()
        let attr = NSMutableAttributedString(string: "Tôi đồng ý với ", attributes: [.foregroundColor: UIColor.secondaryLabel, .font: UIFont.systemFont(ofSize: 13, weight: .regular)])
        attr.append(NSAttributedString(string: "Điều khoản sử dụng", attributes: [.foregroundColor: UIColor.systemBlue, .font: UIFont.systemFont(ofSize: 13, weight: .medium)]))
        attr.append(NSAttributedString(string: " và\n", attributes: [.foregroundColor: UIColor.secondaryLabel, .font: UIFont.systemFont(ofSize: 13, weight: .regular)]))
        attr.append(NSAttributedString(string: "Chính sách bảo mật", attributes: [.foregroundColor: UIColor.systemBlue, .font: UIFont.systemFont(ofSize: 13, weight: .medium)]))
    ...
    private lazy var loginPromptButton: UIButton = {
        let btn = UIButton(type: .system)
        let attr = NSMutableAttributedString(string: "Đã có tài khoản? ", attributes: [.foregroundColor: UIColor.secondaryLabel, .font: UIFont.systemFont(ofSize: 14, weight: .medium)])
        attr.append(NSAttributedString(string: "Đăng nhập", attributes: [.foregroundColor: UIColor.systemBlue, .font: UIFont.systemFont(ofSize: 14, weight: .bold)]))
    ...
    private func setupLayout() {
        ...
        let components = [backButton, titleLabel, subtitleLabel, nameField, emailField, passwordField, confirmPasswordField, termsStack, registerButton, loginPromptButton]
